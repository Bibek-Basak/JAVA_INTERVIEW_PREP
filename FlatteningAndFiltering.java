...
public class FlatteningAndFiltering {
	...
	public static void main(String[] args) {
        ...
        System.out.println(namesList.stream().flatMap(list -> list.stream()).distinct().filter(name -> name.contains("a")).collect(Collectors.toList()));
	}
}
